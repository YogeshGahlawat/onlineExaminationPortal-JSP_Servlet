                ...
                <form action="updateUserRecord" method="POST">
                    ...
                    <div class="input">
                        ...
                        <div class="input-fields">
                            ...
                            <input type="email" name="userMail" id="email" value=<%=session.getAttribute("userMail")%>  onfocusout="validateMail()" required disabled>
                        </div>
                    </div>
                    <div class="input">
                        ...
                        <div class="input-fields">
                            ...
                            <input type="text" name="userPassword" id="password" value=<%=session.getAttribute("userPassword")%>  onfocusout="validatePassword()" required disabled>
                        </div>
                    </div>
